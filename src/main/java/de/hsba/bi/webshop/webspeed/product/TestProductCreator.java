...
public class TestProductCreator {
    ...
    public void init() {
        ...
        Product testprodukt1 = productRepository.save(new Product("Katze", new BigDecimal(1000), "graue Katze, stinkt ein wenig", "Haustiere", "sehr gut", new Double(1), new Double(12), testUser1));
        Product testprodukt2 = productRepository.save(new Product("Hund", new BigDecimal(300), "schwarzer Hund", "Haustiere", "unterdurchschnittlich", new Double(1), new Double(0), testUser1));
